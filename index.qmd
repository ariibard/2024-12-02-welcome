...
::: columns
::: {.column width="50%"}
![](https://avatars.githubusercontent.com/u/64991969?v=4){width="30%" style="border-radius: 80%;"}

**Emanuel Ciardullo**
:::

::: {.column width="50%"}
![](imagenes/jose.png){width="30%" style="border-radius: 80%; aling: center;"}
...
# Próximas actividades <img src="https://media.giphy.com/media/VgCDAzcKvsR6OM0uWg/giphy.gif" width="90"/> {.section}
